...
class handDetector():
    ...
    def findHands(self, img, draw=True):
        ...
        self.reasults = self.hands.process(imgRGB)
        # print(reasults)

        if self.reasults.multi_hand_landmarks:
            for handLms in self.reasults.multi_hand_landmarks:
    ...
    def handPosition(self, img, handNo=0, draw=True):
        ...
        if self.reasults.multi_hand_landmarks:
            ...
            myHand = self.reasults.multi_hand_landmarks[handNo]
